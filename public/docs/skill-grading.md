...
- Skor Assignment /100 = (skor_raw / 15) × 100
...
• Skor 1: System Prompt generik atau tidak ada — tidak ada peran, konteks, atau format spesifik
...
• Skor 3: Relevan untuk pekerjaan nyata peserta + prompt terlihat spesifik ke konteks
...
Interpretasi Total Skor Assignment:
• 12–15 → Baik
• 8–11 → Cukup
• < 8 → Perlu Bimbingan
...
• Skor 2: Semua slide ada tapi alur antar pilar tidak terhubung
• Skor 3: Alur mengalir tapi Diverge/Converge atau Listen Deeply kurang terdokumentasi
• Skor 4: Alur kuat: pain conviction → constraint → opsi → pilihan+alasan → prototype → gap testing → iterasi

Aspek 4 — Bukti Iterasi [I] (bobot 10%, skala 1–4)
• Skor 1: Tidak ada Diverge/Converge — langsung satu solusi tanpa eksplorasi
• Skor 2: Ada beberapa opsi tapi cara memilihnya tidak dijelaskan
• Skor 3: Converge terlihat tapi alasan lemah, atau gap dari user testing tidak ditindaklanjuti
• Skor 4: Diverge → Converge → Commit jelas, gap dari testing diidentifikasi dan direspons di Slide 6

Aspek 5 — Refleksi [Ref] (bobot 10%, skala 1–4)
• Skor 1: Tidak ada atau sangat generik
• Skor 2: Ada tapi hanya positif — tidak mengakui hambatan
• Skor 3: Jujur — hambatan diakui, tapi pain conviction tidak dievaluasi ulang
• Skor 4: Jujur + pain conviction dievaluasi ulang + next step realistis dan spesifik
...
**Total: X/15 — [Baik / Cukup / Perlu Bimbingan]**
...
| Refleksi | 10% | X/4 | XX.XX | [spesifik] |
